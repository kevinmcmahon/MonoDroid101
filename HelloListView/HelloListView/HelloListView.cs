...
namespace HelloListView
{
    ...
    public class HelloListView : ListActivity // derives from ListActivity and not Activity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            ListView.ItemClick +=
                (sender, args) => Toast.MakeText(Application, ((TextView) args.View).Text, ToastLength.Short).Show();
        ...
        private static readonly string[] _countries = new[]
                                                         {
                                                             ...
                                                             "French Southern Territories", "Gabon", "Georgia",
                                                             ...
                                                             "Sqo Tome and Principe", "Saint Helena",
                                                             ...
                                                             "The Gambia", "Togo", "Tokelau", "Tonga",
                                                             "Trinidad and Tobago", "Tunisia", "Turkey",
                                                             "Turkmenistan", "Turks and Caicos Islands", "Tuvalu",
                                                             "Virgin Islands", "Uganda",
